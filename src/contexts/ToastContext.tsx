          ...
          {toasts.map((toast) => (
            <motion.div
              ...
              className={`pointer-events-auto flex items-start gap-3 p-3 min-w-[280px] rounded-xl shadow-lg border backdrop-blur-md ${
                toast.type === "success"
                  ? "bg-emerald-50/90 dark:bg-emerald-950/80 border-emerald-200/50 dark:border-emerald-900/50"
                  : toast.type === "error"
                    ? "bg-rose-50/90 dark:bg-rose-950/80 border-rose-200/50 dark:border-rose-900/50"
            ...
            >
              ...
              <button
                ...
                className={`shrink-0 p-0.5 rounded-md transition-colors ${
                  toast.type === "success"
                    ? "hover:bg-emerald-200/50 dark:hover:bg-emerald-800/50 text-emerald-600 dark:text-emerald-400"
                    : toast.type === "error"
                      ? "hover:bg-rose-200/50 dark:hover:bg-rose-800/50 text-rose-600 dark:text-rose-400"
